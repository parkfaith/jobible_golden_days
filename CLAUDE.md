...
- 테마: 풍경(bg-01~06,08~10,12~21,23,25~41,43~50), 꽃/보케(bg-07,11,22,24,42,54,58,61~63,65~66,68,70), 벚꽃(bg-64), 성당/교회(bg-51,57,59~60), 비/눈/겨울(bg-52~53,56,67,69,71~73), 달리아/금잔화(bg-58,74), 날씨 전용: 비(bg-75~77), 눈(bg-78~80), 흐림(bg-81~83), 맑음(bg-84~87)
